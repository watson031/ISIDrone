...
public class Const {
	...
	public static String PATH_PAGE_LIST_CLIENTS = PATH_PRIVATE + "listClients.jsp";
        ...
        public static String PATH_PAGE_NEW_CATEGORY = PATH_PRIVATE + "newCategory.jsp";

        public static String PATH_PAGE_EDIT_PROFILE = PATH_PRIVATE + "editProfile.jsp";
	...
	//public static String PATH_MENU_PRODUCT = PATH_IMG + "product.png";	// Place Holder Product
        ...
        public static String USER_STATUS_ACTIVATED = "ACTIVATED";
        public static String USER_STATUS_DISACTIVATED = "DISACTIVATED";
