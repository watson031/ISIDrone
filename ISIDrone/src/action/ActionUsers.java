...
public class ActionUsers {
    ...
    public static void getClients(HttpServletRequest request, HttpServletResponse response) {
        request.setAttribute("users", MUser.getAllClients());
    }

    public static void getClientsSearch(HttpServletRequest request, HttpServletResponse response, String userSearch) {
        request.setAttribute("users", MUser.getAllClients(userSearch));
    }

    public static void setStatutClient(HttpServletRequest request, HttpServletResponse response, String statut, int idUser,int idDeactivator) {
        request.setAttribute("users", MUser.isUserActif(idUser,idDeactivator, statut, request.getParameter("raison")));
        }
    public static void getUserById(int clientId, HttpServletRequest request, HttpServletResponse response) {
        request.setAttribute("user", MUser.ClientById(clientId));
    }

    public static boolean editClient(HttpServletRequest request, HttpServletResponse response) {
        return updateClient( request, response);
    }

    private static boolean updateClient( HttpServletRequest request, HttpServletResponse response) {
        entities.User client =  (entities.User) request.getAttribute("user");
        String[] s_formParamsNeeded = {"lastName", "firstName", "email",
                "addr_no", "addr_street", "addr_zip", "addr_city", "addr_state", "addr_country","userStatut"},
        ...
        if (isCompleted) {
            ...
            user.setUserStatus(hm_formParamValue.get("userStatut"));
