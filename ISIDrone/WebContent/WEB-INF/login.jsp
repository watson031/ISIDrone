...
<%      if(hm_errorMsg != null && hm_errorMsg.get("loginState").equals("userInactivated")) {
%>
            <li style="margin-bottom: 0px; white-space: pre-line;">Erreur!! Votre compte a été desactivé</li>
<%                
        }
%>
...
<%
                ...
                if(hm_errorMsg != null && hm_errorMsg.get("loginState").equals("userInactivated")) {
%>
                <li style="margin-bottom: 0px; white-space: pre-line;">Erreur!! Votre compte a été desactive</li>
<%                
                }
	}
%>
